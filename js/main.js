(() => {
  ...
  const houseInfo = [
      ...
      Paramount of the Reach and Wardens of the South after taking control of the region from House Gardener during the Targaryen conquest. The House was formerly led by Lord Mace Tyrell. Mace's son Loras was a noted tournament knight and, secretly, the lover of Lord Renly Baratheon.`]
...
// couldn't get the buttons to function
...
function playPause() {
  ...
  function popLightBox(event) {
    ...
    if (event.target.className.includes('sigilContainer')) {
        ...
        setTimeout(function () { lightBox.classList.add('show-lightbox'); }, 1500);//waiting for the banner animation done then pop up the video
